...
response = requests.get("https://www.ceneo.pl/89981368#tab=reviews")
page = 1
...
while response:
    ...
    response = requests.get("https://www.ceneo.pl/89981368/opinie-" + str(page), allow_redirects=False)
    if response.status_code == 200:
        page += 1
    else:
        break

with open("./opinions/89981368.json", "w", encoding="UTF-8") as f:
